...
const PatternPage = () => {
    ...
    const getLanguageTitle = (lang) => {
        ...
        return titles[lang] || 'Pattern.js';
    };

    const getCurrentCode = () => {
        return pattern[selectedLanguage] || pattern.javascript || '';
    };
            ...
            >
                <Link to="/">
                    <button className="back-button">
                        <svg className='goback' width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="content">
                    <div className="imgandtitle">
                        <h1>{pattern.title}</h1>
                        <div className="pattern-display-card">
                    ...
                    <div className="code">
                        <div className="language-selector">
                            ...
                            <button 
                                className={selectedLanguage === 'php' ? 'active' : ''} 
                            ...
                            <div className="header">
                                <div className="top">
                                    <div className="colors">
                                        ...
                                        <div className="title">
                                            <p id="title2">{getLanguageTitle(selectedLanguage)}</p>
                                        </div>
                                    </div>
                                    <button className="copy" onClick={handleCopyClick}>
                                        ...
                                        <span>
                                            <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="clipboard">
                                            ...
                                            <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="checkmark">
